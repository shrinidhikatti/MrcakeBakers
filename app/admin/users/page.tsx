...
export default function AdminUsersPage() {
  ...
  const [showAddDeliveryPartner, setShowAddDeliveryPartner] = useState(false);
  ...
  return (
    <div className="min-h-screen bg-cream-50 py-8">
      ...
      {showAddDeliveryPartner && (
        <AddDeliveryPartnerModal
          onClose={() => setShowAddDeliveryPartner(false)}
          onSuccess={() => {
            setShowAddDeliveryPartner(false);
            setFilterRole('DELIVERY_PARTNER');
            fetchUsers();
          }}
        />
      )}
...
// Add Delivery Partner Modal Component
function AddDeliveryPartnerModal({
  onClose,
  onSuccess,
}: {
  onClose: () => void;
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Add Delivery Partner</h2>
        </div>
